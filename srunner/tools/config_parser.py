...
def find_scenario_config(scenario_name):
    ...
    # list_of_config_files = glob.glob("{}/srunner/configs/*.xml".format(os.getenv('ROOT_SCENARIO_RUNNER', "./")))
    list_of_config_files = glob.glob("/home/goujs/carla/scenario_runner-0.9.5/srunner/configs/*.xml")
    print("input param scenario_name = ", scenario_name)
    print("list_of_config_files = ", list_of_config_files)
